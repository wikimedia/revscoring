...
OPERATIONS = [Delete(a1=0, a2=1, b1=0, b2=0),
              Insert(a1=0, a2=1, b1=0, b2=1),
              Equal(a1=1, a2=2, b1=1, b2=2),
              Delete(a1=2, a2=3, b1=2, b2=2),
              Insert(a1=2, a2=3, b1=2, b2=3),
              Equal(a1=3, a2=4, b1=3, b2=4),
              Delete(a1=4, a2=5, b1=4, b2=4),
              Insert(a1=4, a2=5, b1=4, b2=5),
              Equal(a1=5, a2=7, b1=5, b2=7),
              Delete(a1=7, a2=8, b1=7, b2=7),
              Insert(a1=7, a2=8, b1=7, b2=8),
              Equal(a1=8, a2=10, b1=8, b2=10),
              Delete(a1=10, a2=12, b1=10, b2=10),
              Insert(a1=10, a2=12, b1=10, b2=12)]
