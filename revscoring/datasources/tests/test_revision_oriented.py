...
def test_revision():
    ...
    check_datasource(revision.parent.user.name)
    ...
    check_datasource(revision.page.namespace)
    ...
    check_datasource(revision.page.creation.user.name)
    ...
    check_datasource(revision.user.name)
    ...
    check_datasource(revision.user.last_revision.page.namespace)
