...
class Revision:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.whitespace_chars = aggregators.sum(
            ...
            name=self.name + ".whitespace_chars", returns=int
        )
        ...
        self.markup_chars = aggregators.sum(
            ...
            name=self.name + ".markup_chars", returns=int
        )
        ...
        self.cjk_chars = aggregators.sum(
            ...
            name=self.name + ".cjk_chars", returns=int
        )
        ...
        self.uppercase_word_chars = aggregators.sum(
            ...
            name=self.name + ".uppercase_word_chars", returns=int
        )
        ...
        self.punctuation_chars = aggregators.sum(
            ...
            name=self.name + ".punctuation_chars", returns=int
        )
        ...
        self.break_chars = aggregators.sum(
            ...
            name=self.name + ".break_chars", returns=int
        )
        "`int` : The number of break characters in the text"

        self.longest_repeated_char = \
            Feature(self.name + ".longest_repeated_char",
...
class Diff:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.numeric_chars_added = aggregators.sum(
            ...
            name=self.name + ".numeric_chars_added", returns=int
        )
        ...
        self.numeric_chars_removed = aggregators.sum(
            ...
            name=self.name + ".numeric_chars_removed", returns=int
        )
        ...
        self.whitespace_chars_added = aggregators.sum(
            ...
            name=self.name + ".whitespace_chars_added", returns=int
        )
        ...
        self.whitespace_chars_removed = aggregators.sum(
            ...
            name=self.name + ".whitespace_chars_removed", returns=int
        )
        ...
        self.markup_chars_added = aggregators.sum(
            ...
            name=self.name + ".markup_chars_added", returns=int
        )
        ...
        self.markup_chars_removed = aggregators.sum(
            ...
            name=self.name + ".markup_chars_removed", returns=int
        )
        ...
        self.cjk_chars_added = aggregators.sum(
            ...
            name=self.name + ".cjk_chars_added", returns=int
        )
        ...
        self.cjk_chars_removed = aggregators.sum(
            ...
            name=self.name + ".cjk_chars_removed", returns=int
        )
        ...
        self.entity_chars_added = aggregators.sum(
            ...
            name=self.name + ".entity_chars_added", returns=int
        )
        ...
        self.entity_chars_removed = aggregators.sum(
            ...
            name=self.name + ".entity_chars_removed", returns=int
        )
        ...
        self.url_chars_added = aggregators.sum(
            ...
            name=self.name + ".url_chars_added", returns=int
        )
        ...
        self.url_chars_removed = aggregators.sum(
            ...
            name=self.name + ".url_chars_removed", returns=int
        )
        ...
        self.word_chars_added = aggregators.sum(
            ...
            name=self.name + ".word_chars_added", returns=int
        )
        ...
        self.word_chars_removed = aggregators.sum(
            ...
            name=self.name + ".word_chars_removed", returns=int
        )
        ...
        self.uppercase_word_chars_added = aggregators.sum(
            ...
            name=self.name + ".uppercase_word_chars_added", returns=int
        )
        ...
        self.uppercase_word_chars_removed = aggregators.sum(
            ...
            name=self.name + ".uppercase_word_chars_removed", returns=int
        )
        ...
        self.punctuation_chars_added = aggregators.sum(
            ...
            name=self.name + ".punctuation_chars_added", returns=int
        )
        ...
        self.punctuation_chars_removed = aggregators.sum(
            ...
            name=self.name + ".punctuation_chars_removed", returns=int
        )
        ...
        self.break_chars_added = aggregators.sum(
            ...
            name=self.name + ".break_chars_added", returns=int
        )
        ...
        self.break_chars_removed = aggregators.sum(
            ...
            name=self.name + ".break_chars_removed", returns=int
        )
        "`int` : The number of break characters removed"

        self.longest_repeated_char_added = \
            Feature(self.name + ".longest_repeated_char_added",
