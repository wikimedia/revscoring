...
class Diff:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.longest_token_added = aggregators.max(
            ...
            name=self.name + '.longest_token_added'
        )
