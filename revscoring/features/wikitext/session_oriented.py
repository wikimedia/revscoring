...
class Session(DependentSet):
    ...
    def __init__(self, name, revisions_datasources):
        ...
        """
        :class:`~revscoring.datasources.meta.expanders.list_of`(:class:`~revscoring.features.wikitext.Revision`) :
...
* session: :class:`~revscoring.features.wikibase.Session`
    * revisions: a :class:`~revscoring.datasources.meta.expanders.list_of`(:class:`~revscoring.features.wikitext.Revision`)
        * parent: a :class:`~revscoring.datasources.meta.expanders.list_of`(:class:`~revscoring.features.wikitext.Revision`)
        * diff: a a :class:`~revscoring.datasources.meta.expanders.list_of`(:class:`~revscoring.features.wikitext.Diff`)
"""
