...
numeric_chars_added = aggregators.sum(
    ...
    name=prefix + ".numeric_chars_added", returns=int
)
"""
...
numeric_chars_removed = aggregators.sum(
    ...
    name=prefix + ".numeric_chars_removed", returns=int
)
"""
...
whitespace_chars_added = aggregators.sum(
    ...
    name=prefix + ".whitespace_chars_added", returns=int
)
"""
...
whitespace_chars_removed = aggregators.sum(
    ...
    name=prefix + ".whitespace_chars_removed", returns=int
)
"""
...
markup_chars_added = aggregators.sum(
    ...
    name=prefix + ".markup_chars_added", returns=int
)
"""
...
markup_chars_removed = aggregators.sum(
    ...
    name=prefix + ".markup_chars_removed", returns=int
)
"""
...
cjk_chars_added = aggregators.sum(
    ...
    name=prefix + ".cjk_chars_added", returns=int
)
"""
...
uppercase_word_chars_added = aggregators.sum(
    ...
    name=prefix + ".uppercase_word_chars_added", returns=int
)
"""
...
uppercase_word_chars_removed = aggregators.sum(
    ...
    name=prefix + ".uppercase_word_chars_removed", returns=int
)
"""
