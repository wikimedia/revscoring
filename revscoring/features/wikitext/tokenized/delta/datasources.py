from .....datasources.meta import frequencies
...
markup_delta = frequencies.delta(
    revision.parent.datasources.markup_frequency,
...
cjk_delta = frequencies.delta(
    revision.parent.datasources.cjk_frequency,
...
entity_delta = frequencies.delta(
    revision.parent.datasources.entity_frequency,
...
url_delta = frequencies.delta(
    revision.parent.datasources.url_frequency,
