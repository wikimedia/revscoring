...
BADWORDS = set([
    "aboput", "anjing",
    "bajingan", "bangsat", "bispak", "bloon", "blo'on", "brengsek", "bishopsgarth", "bastards", "bencong", "babi"
    "cibai", "chalong", "coley",
    "diselama", "dishonest", "defraud", "defamatory",
    "escoduro",
    "fredrike", "fogh",
    "gauguin", "goblok", "geftapo", "gestapo",
    "heroin", "husseins",
    "indon",
    "jambut", "jancuk", "jancok", "jellinek", "jellygamat",
    "keparat", "kontol",
    "lonte", "loked", "lvmh",
    "malingsia", "memek", "monyong", "munch",
    "netnapa", "ngentot", "nesbitt",
    "overdosed",
    "panadta", "palaji", "perek", "pukimak", "portugeuse", "paedophiles", "prostituton", "paedophile", "pedofil",
    "riyhad",
    "satanic", "satanists", "sempak", "sinting", "steinway", "sukhano",
    "terrorising", "terrorised", "terrorists", "taenjamras", "tetek", "titit", "toket", "tzcesar", "thailaland", "thaicia"
])
