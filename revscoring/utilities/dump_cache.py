...
Usage:
    cache2feature_tsv.py <features> <label> [<model>]
...
def main(argv=None):
    ...
    run(observations, output, features, label_name, model, verbose)


def run(observations, output, features, label_name, model, verbose):
