# -*- coding: utf-8 -*-
#
# Revision Scoring documentation build configuration file, created by
...
htmlhelp_basename = 'RevisionScoringdoc'
...
latex_documents = [
  (master_doc, 'RevisionScoring.tex', u'Revision Scoring Documentation',
   u'Revision Scoring team', 'manual'),
]
...
man_pages = [
    (master_doc, 'revisionscoring', u'Revision Scoring Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RevisionScoring', u'Revision Scoring Documentation',
   author, 'RevisionScoring', 'One line description of project.',
   'Miscellaneous'),
]
